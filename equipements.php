      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="equipements.php">Equipements</a></li>
            <li class="dropdown">
    ...
    <div class="container">
      <?php for($i=0; $i < $records_per_page; $i++) {?>
        <div class="row item">
          ...
          <div class="col-md-9">
            <h3><a href="researchtheme.php">Equipement Name</a></h3>
            <p>
              Description for research equipement. Description for research equipement. Description for research equipement. 
              Description for research equipement. Description for research equipement. Description for research equipement. 
              Description for research equipement.
            </p>
          </div>
        </div>
