  ...
  <body>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a href="members.php">People</a></li>
    ...
    <div class="container">
      <?php for($i=0; $i < $records_per_page; $i++) {?>
        <div class="row item">
          <div class="col-md-2">
            <a href="researchtheme.php"><img class="small" src="assets/img/default-male.jpg"/></a>
          </div>
          <div class="col-md-9">
            <h3><a href="researchtheme.php">Dr. Islam Shoukry</a></h3>
            <p>
              Some brief stuff about the person, or not.
            </p>
          </div>
        </div>
